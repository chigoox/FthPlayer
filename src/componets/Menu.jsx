...
function Menu() {
    return (
        <div className='grid  absolute right-0 bottom-24 z-50 hover:border-black text-white h-16 w-16 hover:h-40 hover:w-40 drop-shadow hover:drop-shadow-xl rounded-full bg-rose-400 shadow-white  m-14 hover:gap-3 hover:scale-105 trans-slow border-[#FF194D] border-[17px]   gap-1 grid-cols-2 hover:rotate-[-45deg] grid-rows-2'>
